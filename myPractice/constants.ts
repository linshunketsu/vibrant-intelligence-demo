...
import { Provider, BankAccount, AtRiskPatient, Transaction, PracticeDocument, GrowthData, RevenueData, CostData, ServiceFeeTemplate, ServiceFeeTrigger, ProviderRevenueData, VibrantRevenueData } from './types';
...
export const MOCK_REVENUE_BREAKDOWN_DATA: RevenueData[] = [
...
export const MOCK_PROVIDER_REVENUE_DATA: ProviderRevenueData[] = [
...
export const MOCK_VIBRANT_REVENUE_DATA: VibrantRevenueData[] = [
...
export const MOCK_COST_BREAKDOWN_DATA: CostData[] = [
...
export const MOCK_DOCUMENTS: PracticeDocument[] = [
    ...
    { id: 'd4', title: 'Practice Privacy Policy.pdf', type: 'Template', uploadedBy: 'Admin', uploadedByAvatar: 'https://picsum.photos/seed/adm/50/50', date: '2024-05-18' },
